...
*/
const MDS_GF_FDBK = 0x169; /* primitive polynomial for GF(256)*/
const LFSR1 = (x: number) => ((x >> 1) ^ ((x & 0x01) ? MDS_GF_FDBK / 2 : 0))
const LFSR2 = (x: number) => ((x >> 2) ^ ((x & 0x02) ? MDS_GF_FDBK / 2 : 0) ^ ((x & 0x01) ? MDS_GF_FDBK / 4 : 0))

const Mx_1 = (x: number) => x;
const Mx_X = (x: number) => x ^ LFSR2(x);	/* 5B */
const Mx_Y = (x: number) => x ^ LFSR1(x) ^ LFSR2(x);	/* EF */

export const M00 = Mx_1;
export const M01 = Mx_Y;
export const M02 = Mx_X;
export const M03 = Mx_X;
export const M10 = Mx_X;
export const M11 = Mx_Y;
export const M12 = Mx_Y;
export const M13 = Mx_1;
export const M20 = Mx_Y;
export const M21 = Mx_X;
export const M22 = Mx_1;
export const M23 = Mx_Y;
export const M30 = Mx_Y;
export const M31 = Mx_1;
export const M32 = Mx_Y;
export const M33 = Mx_X;
...
*/
export const	P_00 = 1;			/* "outermost" permutation */
export const	P_01 = 0;
export const	P_02 = 0;
export const	P_03 = 1;			/* "extend" to larger key sizes */
export const	P_04 = 1;
export const	P_10 = 0;
export const	P_11 = 0;
export const	P_12 = 1;
...
***********************************************************************/
export const P8x8: [number[], number[]] = [
/*  p0:   */
